...
import com.xm4399.util.{CreateKuduTable, CreateKuduTable2, GetAllSmallTableName, GetTableStru, GetTableStru2}
...
object MyTest {
  def main(args: Array[String]): Unit = {
    ...
    if (3 == argsLen) {
      val smallTableNameList = GetAllSmallTableName.getAllSmallTableName(args(0), args(1)).asScala
