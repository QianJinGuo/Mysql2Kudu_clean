...
public class GetTableStru {
    ...
    public static LinkedHashMap<String, String[]> getTableStru2(String address, String username, String password, String dbName, String tableName, String isSubTable){
        Connection con = null;
        LinkedHashMap<String,String[]>  fieldInfoMap = new LinkedHashMap<String, String[]>();
        //如果传入的为分表,则从分表   获取表结构
        if("true".equals(isSubTable)){
